...
import music_stream_app_backend.dtos.ChartResponseDTO;
...
public class ChartService {
        ...
        public ChartTrackResponseDTO addTrackToChart(ChartTrackRequestDTO chartTrackRequestDTO) {
                ...
                List<TrackResponseDTO> tracks = chartTrackRepository
                                .findTracksByChartId(chartTrackRequestDTO.getChartId())
                                .stream()
        ...
        public List<ChartResponseDTO> getAllCharts() {
                return chartRepository.findAll().stream()
                                .map(chart -> ChartResponseDTO.builder()
                                                .id(chart.getId())
                                                .title(chart.getTitle())
                                                .image(chart.getImage())
                                                .build())
